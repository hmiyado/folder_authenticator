...
void main() {
  ...
  group('folderEntriesProvider', () {
    test('should return folder path and entries when data is available', () async {
      // Arrange
  ...
  group('allFolderEntriesProvider', () {
    ...
    test('should return entries from parent and subfolders', () async {
      ...
      // Setup subfolder
      final subfolder = Folder(id: 1, name: 'Subfolder', parentId: Folder.rootFolderId);
    ...
    test('should not skip folders with no entries', () async {
      ...
      final subfolder = Folder(id: 1, name: 'Empty Subfolder', parentId: rootFolder.id);
      final subfolderPath = [rootFolder, subfolder];
